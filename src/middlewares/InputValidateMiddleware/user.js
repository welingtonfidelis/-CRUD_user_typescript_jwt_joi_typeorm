...
var get_1 = __importDefault(require("./schema/user/get"));
var show_1 = __importDefault(require("./schema/user/show"));
var post_1 = __importDefault(require("./schema/user/post"));
var put_1 = __importDefault(require("./schema/user/put"));
var delete_1 = __importDefault(require("./schema/user/delete"));
...
var inputValidate = function (req, res, next) {
    ...
    switch (req.method.toLowerCase()) {
        case 'get':
            schema = req.params.id ? show_1.default : get_1.default;
            break;
        case 'post':
            schema = post_1.default;
            break;
        case 'put':
            schema = put_1.default;
            break;
        default:
            schema = delete_1.default;
            break;
    }
